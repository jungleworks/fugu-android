...
class AudioDeviceHandlerConnectionService implements
    ...
    private static int audioDeviceToRouteInt(String audioDevice) {
        ...
        JitsiMeetLogger.e(TAG + "device name: " +audioDevice);
    ...
    public void onCallAudioStateChange(final CallAudioState state) {
        module.runInAudioThread(new Runnable() {
            ...
            public void run() {
                ...
                JitsiMeetLogger.d(TAG + " getRoute " + state.getRoute());
            JitsiMeetLogger.d(TAG + " getSelectedDevice " + module.getSelectedDevice());
            JitsiMeetLogger.d(TAG + " getSupportedRouteMask "+ state.getSupportedRouteMask());
            JitsiMeetLogger.d(TAG + " supportedRouteMask "+ supportedRouteMask);
            }
        });
    }
