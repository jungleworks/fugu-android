...
public class ShowMoreVideoFragment extends Fragment {
    ...
    private ArrayList<Integer> videoMessagetypeList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_show_more_video, container, false);
        rvMedia = view.findViewById(R.id.rvShowMoreVideo);
        ...
        rvMedia.addOnItemTouchListener(new BigGalleryAdapter.RecyclerTouchListener(mContext.getApplicationContext(), rvMedia, new BigGalleryAdapter.ClickListener() {
            ...
            public void onClick(View view, int position) {
                if(!TextUtils.isEmpty(com.skeleton.mvp.fugudatabase.CommonData.getCachedFilePath(mediaList.get(position).getMessage().getUrl(),mediaList.get(position).getMuid()))) {
        ...
        videoMessagetypeList = new ArrayList<>();
        videoMessagetypeList.add(12);
        mListener.apiGetMedia(videoMessagetypeList, 0, 20, new ShowMoreActivity.ResultCallback() {
            @Override
    ...
    private void setEndlessScrolling(){
        endlessScrolling=new EndlessScrolling((LinearLayoutManager) rvMedia.getLayoutManager()) {
            ...
            public void onLoadMore(int currentPages) {
                ...
                videoMessagetypeList = new ArrayList<>();
                videoMessagetypeList.add(12);
                mListener.apiGetMedia(videoMessagetypeList, start, end, (data, messageType) -> {
                    if(messageType == 12){
