...
public class ShowMoreDocumentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_show_more_document, container, false);
        rvMedia = view.findViewById(R.id.rvShowMoreDocument);
        ...
        documentMessagetypeList = new ArrayList<>();
        documentMessagetypeList.add(11);
        mListener.apiGetMedia(documentMessagetypeList, 0, 20, new ShowMoreActivity.ResultCallback() {
            @Override
    ...
    private void setEndlessScrolling(){
        endlessScrolling=new EndlessScrolling((LinearLayoutManager) rvMedia.getLayoutManager()) {
            ...
            public void onLoadMore(int currentPages) {
                ...
                documentMessagetypeList = new ArrayList<>();
                documentMessagetypeList.add(11);
                mListener.apiGetMedia(documentMessagetypeList, start, end, (data, messageType) -> {
                    if(messageType == 11){
