...
import com.skeleton.mvp.utils.HeaderViewProfile;
...
public class HeaderBehaviourProfile extends CoordinatorLayout.Behavior<HeaderViewProfile> {
    ...
    public HeaderBehaviourProfile(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public HeaderBehaviourProfile(Context context, AttributeSet attrs, Context mContext) {
        super(context, attrs);
