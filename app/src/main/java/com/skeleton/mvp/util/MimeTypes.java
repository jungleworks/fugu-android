...
public class MimeTypes {
    ...
    public static final String MIME_APPLICATION_VND_MSPOWERPOINTX = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
    ...
    public static final String MIME_COMMA_SEPERATED_VALUES = "text/comma-separated-values";
    ...
    static {
        extMapping = new HashMap<String, String>(200) {
...

            {
                ...
                put1(MIME_APPLICATION_VND_MSPOWERPOINTX, "pptx");
                ...
                put1(MIME_COMMA_SEPERATED_VALUES, "csv");
                put1(MIME_TEXT_CSV, "csv");
    ...
    public static String lookupExt(String mimeType) {
        if (extMapping.get(mimeType.toLowerCase()) == null) {
            return "unknown";
        } else {
            if(extMapping.get(mimeType.toLowerCase()).equals("png")){
                return "jpg";
