...
final class EmojiVariantPopup {
    ...
    @Nullable final com.skeleton.mvp.util.OnEmojiClickListener listener;
    @Nullable
    EmojiImageView rootImageView;

    public EmojiVariantPopup(@NonNull final View rootView, @Nullable final com.skeleton.mvp.util.OnEmojiClickListener listener) {
