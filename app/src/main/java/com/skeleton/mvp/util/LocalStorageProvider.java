...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public static final String AUTHORITY = BuildConfig.APPLICATION_ID + ".localstorage.documents";
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(Root.COLUMN_TITLE, "Select");
        row.add(Root.COLUMN_FLAGS, Root.FLAG_LOCAL_ONLY | Root.FLAG_SUPPORTS_CREATE);
        row.add(Root.COLUMN_ICON, R.drawable.ic_fugu);
    ...
    private void includeFile(final MatrixCursor result, final File file)
        ...
        // The system provides default ic_link_google
        // based on mime type
