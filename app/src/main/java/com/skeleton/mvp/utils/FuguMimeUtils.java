 ...
 * @since 03/06/2020
 */
public final class FuguMimeUtils {
    ...
    static {
        // This list is NOT in alphabetical order and must not be sorted.
        // The MOST POPULAR extension must come first, so that it's the one returned by guessExtensionFromMimeType.
        ...
        // adding ".mp3" first so it will be the default for guessExtensionFromMimeType
        add("audio/mpeg", "mp3");
        add("audio/aac", "aac");
        add("audio/mpeg", "mpga");
        ...
        add("text/iuls", "uls");
        add("text/mathml", "mml");
        // adding ".txt" first so it will be the default for guessExtensionFromMimeType
        add("text/plain", "txt");
        add("text/plain", "json");
        add("text/plain", "asc");
        add("text/plain", "text");
