package com.skeleton.mvp.utils.beatAnimation;
...
public class AVLoadingIndicatorViewFugu extends View {

    private static final String TAG="AVLoadingIndicatorView";

    private static final BallPulseIndicatorFugu DEFAULT_INDICATOR=new BallPulseIndicatorFugu();
    ...
    public AVLoadingIndicatorViewFugu(Context context) {
        super(context);
        init(context, null,0,0);
    }

    public AVLoadingIndicatorViewFugu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs,0, R.style.AVLoadingIndicatorView);
    }

    public AVLoadingIndicatorViewFugu(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs,defStyleAttr,R.style.AVLoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AVLoadingIndicatorViewFugu(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
