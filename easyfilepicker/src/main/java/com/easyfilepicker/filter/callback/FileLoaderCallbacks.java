...
import com.easyfilepicker.filter.entity.*;
import com.easyfilepicker.filter.loader.AudioLoader;
import com.easyfilepicker.filter.loader.FileLoader;
import com.easyfilepicker.filter.loader.ImageLoader;
import com.easyfilepicker.filter.loader.VideoLoader;
...
public class FileLoaderCallbacks implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void onImageResult(Cursor data) {
        ...
        while (data.moveToNext()) {
            ...
            img.setMimeType(data.getString(data.getColumnIndexOrThrow(MIME_TYPE)));
