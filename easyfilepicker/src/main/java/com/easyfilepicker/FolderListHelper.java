...
import com.easyfilepicker.adapter.FolderListAdapter;
...
public class FolderListHelper {
    ...
    public void toggle(View anchor) {
        if (mPopupWindow.isShowing()) {
            ...
            if(height > mContentView.getMeasuredHeight())
                height = mContentView.getMeasuredHeight();
            mPopupWindow.update(anchor, mContentView.getMeasuredWidth(), height);
        }
    }
