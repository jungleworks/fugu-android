...
public class MonthCalendar extends LinearLayout implements ViewPager.OnPageChangeListener,
    ...
    private CountDownTimer searchTimer = new CountDownTimer(500, 500) {
        @Override
    ...
    private void init() {
        ...
        monthHeaderView = findViewById(R.id.month_header);
        monthGridView = findViewById(R.id.month_grid);
    }
    ...
    public void prepareCalendar(final MonthCalendarConfiguration monthCalendarConfiguration) {
        ...
        current_month.setText(new SimpleDateFormat(DateUtils.MMMM_yyyy, Locale.ENGLISH).format(monthCalendarConfiguration.getInitialDay().getTime()));
        ...
        backgroundHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                monthAdapter = new MonthAdapter(getContext(), monthHandlerThread,
    ...
    public void setSelectedDay(Calendar selectedDay, boolean scrollToSelectedDay) {
        current_month.setText(new SimpleDateFormat(DateUtils.MMMM_yyyy, Locale.ENGLISH).format(selectedDay.getTime()));
    ...
    private void checkMonth() {
        ...
        if (currentMonth != selectedMonth) {
            ...
            current_month.setText(new SimpleDateFormat(DateUtils.MMMM_yyyy, Locale.ENGLISH).format(selectedMonth.getTime()));
            if (onMonthChangeListener != null) {
                searchTimer.cancel();
                searchTimer = new CountDownTimer(500, 1000) {
                    @Override
                    public void onTick(long millisUntilFinished) {
